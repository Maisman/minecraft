...
public class MCreatorChangeDimensionCommandExecuted extends Elementsdimensional_dungeon.ModElement {
	public MCreatorChangeDimensionCommandExecuted(Elementsdimensional_dungeon instance) {
		super(instance, 51);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure MCreatorChangeDimensionCommandExecuted!");
			return;
		}

...
public class MCreatorChangeDimensionCursedLandCommandExecuted extends Elementsdimensional_dungeon.ModElement {
	public MCreatorChangeDimensionCursedLandCommandExecuted(Elementsdimensional_dungeon instance) {
		super(instance, 79);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure MCreatorChangeDimensionCursedLandCommandExecuted!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		if (!entity.world.isRemote && !entity.isRiding() && !entity.isBeingRidden() && entity instanceof EntityPlayerMP) {
			int dimensionID = MCreatorCursedLand.DIMID;

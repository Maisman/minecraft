...
public class MCreatorDarkSword extends Elementsdimensional_dungeon.ModElement {
	@GameRegistry.ObjectHolder("dimensional_dungeon:darksword")
	public static final Item block = null;

	public MCreatorDarkSword(Elementsdimensional_dungeon instance) {
		super(instance, 43);
	}

	@Override
	public void initElements() {
		elements.items.add(() -> new ItemSword(EnumHelper.addToolMaterial("DARKSWORD", 10, 2380, 16f, 6f, 70)) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("dimensional_dungeon:darksword", "inventory"));
	}
}

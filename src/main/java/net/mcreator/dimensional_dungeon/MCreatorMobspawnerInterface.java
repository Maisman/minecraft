...
public class MCreatorMobspawnerInterface extends Elementsdimensional_dungeon.ModElement {
	public static int GUIID = 1;
	public static HashMap guiinventory = new HashMap();

	public MCreatorMobspawnerInterface(Elementsdimensional_dungeon instance) {
		super(instance, 8);
	}
	...
	public static class GuiContainerMod extends Container {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				dimensional_dungeon.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + -110, this.guiTop + -22, 120, 20, "Summon Smith"));
		}

		@Override
		protected void actionPerformed(GuiButton button) {
			dimensional_dungeon.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
		...
		if (buttonID == 0) {
			{
				...
				MCreatorWeaponsSmith.executeProcedure($_dependencies);
			}
		}
	}
